...
class CCXTOKXClient:
    ...
    def _ensure_exchange(self):
        ...
        if self._markets is None:
            try:
                ...
                raise OKXAPIError("ccxt", "load_markets", message=str(exc)) from exc
    ...
    def ticker(self, inst_id):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_ticker", {"instId": inst_id, "symbol": symbol}, message=str(exc)) from exc
    ...
    def candles(self, inst_id, bar, limit=180):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_ohlcv", {"instId": inst_id, "symbol": symbol, "bar": bar, "limit": limit}, message=str(exc)) from exc
    ...
    def order_book(self, inst_id, depth=20):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_order_book", {"instId": inst_id, "symbol": symbol, "depth": depth}, message=str(exc)) from exc
    ...
    def trades(self, inst_id, limit=100):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_trades", {"instId": inst_id, "symbol": symbol, "limit": limit}, message=str(exc)) from exc
    ...
    def funding_rate(self, inst_id):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_funding_rate", {"instId": inst_id, "symbol": symbol}, message=str(exc)) from exc
    ...
    def open_interest(self, inst_id):
        ...
        try:
            ...
            raise OKXAPIError("ccxt", "fetch_open_interest", {"instId": inst_id, "symbol": symbol}, message=str(exc)) from exc
